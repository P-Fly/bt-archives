...
发现 **Swift Pair peripherals** 是通过 **BLE** 协议，需要使用 **LE advertisements**：
 ...
 - 快速发现阶段：信标每 **30ms** 一次，持续大于 **30S**。

 - 正常节奏阶段：信标每 **100ms** 或 **152.5ms** 一次。
...
## 有关 Swift Pair 通知的外设信息
 ...
 - 外设需要定义 **Class of Device (CoD)** 或 **Peripheral Name**，并包含在相同的广播包中。
...
## Swift Pair 所需的规格功能
 ...
 - 如果双模外设希望同时通过 **BR/EDR** 和 **LE** 进行配对，则该外设必须支持两种协议的安全连接。
...
## 推荐经验
 ...
 - 双模外设通过 **Paring over Bluetooth LE and BR/EDR with Secure Connections** 可以节省负载空间。
